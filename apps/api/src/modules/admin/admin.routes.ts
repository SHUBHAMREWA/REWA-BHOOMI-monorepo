...
import { getDashboardStats, listUsers, updateUserStatus, updateUserRole, moderateProperty, getAuditLogs, listPropertiesAdmin, listProjectsAdmin, togglePropertyPopular, deletePropertyAdmin, bulkDeletePropertiesAdmin, broadcastPropertyNotificationAdmin } from './admin.controller';
...
router.post('/properties/:id/notify', asyncHandler(broadcastPropertyNotificationAdmin));
